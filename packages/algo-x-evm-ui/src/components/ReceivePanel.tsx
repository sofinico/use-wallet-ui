  ...
  return (
    <>
      ...
      <p className="text-xs text-[var(--wui-color-text-secondary)] mb-2 leading-relaxed">
        This is your xChain Account. You can receive ALGO and any opted-in assets here, and manage your asset opt-ins below.
      </p>

      {/* Address display */}
      {activeAddress && (
        <div className="mb-4 bg-[var(--wui-color-bg-secondary)] rounded-lg p-3">
          <p className="text-xs text-[var(--wui-color-text-secondary)] mb-1.5">Your xChain EVM address:</p>
